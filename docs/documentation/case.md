...
| `bubble_inlet`        | Logical | Reinsert bubbles at the bottom when they exit the domain |
...
- `bubble_inlet` When true, bubbles that exit the top boundary are reinserted at the bottom, enabling a continuous stream.
